defmodule Ash.Modbus.RequestTest do
  use ExUnit.Case
  ...
  test "Request pack and parse test" do
    ...
    # corner cases
    pp(
      <<0x22, 0x0F, 0x23, 0x24, 0x00, 0x08, 0x01, 0x96>>,
    ...
    pp(
      <<0x22, 0x0F, 0x23, 0x24, 0x07, 0xF8, 0xFF>> <> l2b1(bls(2040)),
      {:fc, 0x22, 0x2324, bls(2040)}
    )

    pp(
      <<0x22, 0x10, 0x23, 0x24, 0x00, 0x7F, 0xFE>> <> l2b16(rls(127)),
